<script setup>
// Tài khoản cá nhân: sửa hồ sơ (full_name/phone/address) + đổi mật khẩu (mục 6.1).
...
async function submitProfile() {
  ...
  try {
    ...
    // Đồng bộ lại auth.store.user -> tên ở header/navbar đổi theo ngay lập tức
...
async function submitPassword() {
  ...
  try {
    ...
    // Trường hợp phổ biến nhất: 400 WRONG_OLD_PASSWORD
